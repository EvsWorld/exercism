...
// ! I think they might have the structure a bit different. It might be a rules dictionary or array
// yea, I think they want me to loop over this and then decide to apply each rule or not.
//
...
export const investingRisk = (transactionAnalysis: TransactionAnalysis) => {
  ...
  const completeTransactionAnalysis = transactionAnalysis.reduce((acc, cur) => {
